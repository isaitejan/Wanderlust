...
class Home extends Component {
    ...
    getPackages = () => {
        ...
        continent = continent[0].toUpperCase() + continent.slice(1).toLowerCase()
        this.setState({continent: continent},()=> sessionStorage.setItem('continent', this.state.continent))
                        ...
                        <div className="mx-auto text-center">
                            ...
                            <div className="form-inline d-flex">
                                <input
                                    ...
                                    placeholder="Where?"
                                />&nbsp;
                    <button className="btn btn-info btn-lg mx-auto" onClick={this.getPackages}>Search</button>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50"><Link to="/home">nadakuditi.saiteja@infosys.com</Link></div>
                                    </div>
                                </div>
                            </div>
