...
class StaticPackage extends Component {
    ...
    render() {
        ...
        return (
        <div className="card bg-light text-dark package-card mt-4" key={singlePackage.destinationId}>
            <div className="card-body row">
                <div className="col-md-4">
                    <img src={singlePackage.imageUrl} className="package-image" alt="destination comes here" />
                </div>
